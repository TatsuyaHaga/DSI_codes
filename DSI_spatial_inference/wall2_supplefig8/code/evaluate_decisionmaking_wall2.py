...
for trial in range(Nsim):
    ...
    while shortest_path_length < min_dist or not (pos[idx_start][0]<8 and pos[idx_start][0]>=5 and pos[idx_start][1]<15 and pos[idx_start][1]>=5 and pos[idx_goal][0]>=12 and pos[idx_goal][0]<15 and pos[idx_goal][1]<15 and pos[idx_goal][1]>=5):
