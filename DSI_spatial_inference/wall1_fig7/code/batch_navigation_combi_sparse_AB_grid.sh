...
do
    python inference_vectors_sparse_CB_grid.py $VEC vector_from.csv vector_from_infer.csv ${N_ELEMENT} is_gridcell.csv > vector_from_maxmin.txt
    python inference_vectors_sparse_CB_grid.py $VEC vector_goal.csv vector_goal_infer.csv ${N_ELEMENT} is_gridcell.csv > vector_goal_maxmin.txt
