...
do
    ...
    do
        ...
        python evaluate_decisionmaking_wallconnect.py adjacency_$CONTEXT.csv vector_from_infer.csv vector_goal_infer.csv graph$CONTEXT.pickle > decisionmaking_result.txt
