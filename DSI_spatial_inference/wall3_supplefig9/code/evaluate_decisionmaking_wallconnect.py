...
for trial in range(Nsim):
    ...
    while shortest_path_length < min_dist or not (pos[idx_start][0]<10 and pos[idx_start][0]>=5 and pos[idx_start][1]<10 and pos[idx_goal][0]>=15 and pos[idx_goal][1]<10):
