...
max_len_ratio = 3 #maximum length of simulation (relative to the shortest path length)
...
optimal_ratio = numpy.sum(numpy.array(diff_pathlength)==0)
...
plt_setspines()
pylab.hist(path_length_ratio, bins=10)
